...
ALTER TABLE [AEFI].[TL_Usuario_Rol] DROP CONSTRAINT fk_Rol_Usuario;
ALTER TABLE [AEFI].[TL_Usuario_Rol] DROP CONSTRAINT fk_Usuario_Rol;
...
ALTER TABLE [AEFI].[TL_Usuario_Rol] DROP CONSTRAINT pk_Usuario_RolID;
...
DROP TABLE [AEFI].[TL_Usuario_Rol];
